                            ...
                            return (
                                <View style={{ width: '100%', alignItems: 'center', marginTop: 50 }}>
                                    <View style={{ width: '95%', marginVertical: 10, alignItems: 'center', }}>
                                        ...
                                        <View style={{ width: '95%', flexDirection: 'row', alignItems: 'center', paddingVertical: 2 }}>
                                            <Iconviewcomponent
                                                Icontag={'FontAwesome'}
                                                iconname={'star'}
                                                icon_size={20}
                                        ...
                                        <View style={{ width: '100%', paddingVertical: 5, alignItems: 'center', marginTop: 10 }}>
                                            <View style={{ width: '100%', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                                                <View style={{ flex: 1, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: 10, paddingVertical: 20, backgroundColor: '#EFFAFF', borderRadius: 10 }}>
                                                ...
                                                <View style={{ flex: 1, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: 10, paddingVertical: 30, backgroundColor: '#EFFAFF', borderRadius: 10 }}>
                                                    <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                                                        <Iconviewcomponent
                                                            Icontag={'FontAwesome'}
                                                            iconname={'users'}
                                                    ...
                                                    <View style={{ flex: 2, justifyContent: 'flex-start', alignItems: 'flex-start' }}>
                                                        <Text style={{ width: '100%', textAlign: 'center', fontSize: 16, color: Color.primary, fontFamily: Poppins.Bold, paddingHorizontal: 5 }}>20-50</Text>
                                                        <Text style={{ width: '100%', fontSize: 13, textAlign: 'center', color: Color.secondary, fontFamily: Poppins.Medium, paddingHorizontal: 5 }} numberOfLines={2}>Employees</Text>
                                                    </View>
                                                </View>
                                            </View>
                                        </View>
                                        ...
                                        <View style={{ width: '100%', paddingHorizontal: 10, marginTop: 10 }}>
                                            <View style={{ paddingVertical: 5, }}>
                                                ...
                                                <View style={{ width: '100%', flexDirection: 'row', justifyContent: 'flex-start', alignItems: 'flex-start', paddingVertical: 10 }}>
                                                    ...
                                                    <TouchableOpacity style={{ width: 44, height: 44, justifyContent: 'center', alignItems: 'center', backgroundColor: '#4867aa', borderRadius: 50, marginHorizontal: 5 }}>
                                                        <Iconviewcomponent
                                                            Icontag={'Fontisto'}
                                                            iconname={'facebook'}
                                                            icon_size={22}
                                                    ...
                                                    <TouchableOpacity style={{ width: 44, height: 44, justifyContent: 'center', alignItems: 'center', backgroundColor: '#f00', borderRadius: 50, marginHorizontal: 5 }}>
                                                        <Iconviewcomponent
                                                            Icontag={'Entypo'}
                                                            iconname={'youtube'}
                                                            icon_size={22}
                                                    ...
                                                    <TouchableOpacity style={{ width: 44, height: 44, justifyContent: 'center', alignItems: 'center', backgroundColor: '#ff66bf', borderRadius: 50, marginHorizontal: 5 }}>
                                                        <Iconviewcomponent
                                                            Icontag={'Entypo'}
                                                            iconname={'instagram'}
                                                            icon_size={22}
