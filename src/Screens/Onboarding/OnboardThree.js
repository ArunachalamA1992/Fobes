            ...
            <View style={{ flex: 1, backgroundColor: 'white' }}>
                ...
                <View style={{ justifyContent: 'flex-end', alignItems: 'center', bottom: 0, backgroundColor: 'white', paddingVertical: 20 }}>
                    <View style={{ width: '100%', flexDirection: 'row', justifyContent: 'flex-end', alignItems: 'center' }}>
                        ...
                        <TouchableOpacity onPress={() => navigation.navigate("Auth")} style={{ paddingHorizontal: 20, padding: 10, }}>
                            <Text style={{ fontSize: 16, color: Color.primary, fontFamily: Poppins.SemiBold }}>Login</Text>
                        </TouchableOpacity>
                    </View>
                </View>
            </View>
