            ...
            <View style={{ flex: 1, backgroundColor: 'white' }}>
                ...
                <View style={{ justifyContent: 'flex-end', alignItems: 'center', bottom: 0, backgroundColor: 'white', paddingVertical: 20 }}>
                    <View style={{ width: '100%', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                        <TouchableOpacity onPress={() => navigation.navigate("OnboardOne")} style={{ paddingHorizontal: 20, padding: 10, }}>
                            <Text style={{ fontSize: 16, color: '#666', fontFamily: Poppins.SemiBold }}>Prev</Text>
                        </TouchableOpacity>
                        <TouchableOpacity onPress={() => navigation.navigate("OnboardThree")} style={{ paddingHorizontal: 20, padding: 10, }}>
