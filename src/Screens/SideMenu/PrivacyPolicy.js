                            ...
                            return (
                                <View style={{ width: scr_width, backgroundColor: 'white' }}>
                                    ...
                                    <View style={{ width: '100%', alignItems: 'center', paddingHorizontal: 10 }}>
                                        ...
                                        <View style={{ width: '100%', paddingVertical: 10, alignItems: 'center', marginTop: 10 }}>
                                            <Text style={{ width: '100%', textAlign: 'justify', fontSize: 17, color: Color.lightBlack, lineHeight: 25, letterSpacing: 0.5, fontWeight: '800' }}>This privacy policy explains how we collect, use and protect your personal information when you visit our job portal website. We respect your privacy and are committed to safeguarding your data in accordance with applicable laws and regulations. By using our website, you consent to the terms of this policy.</Text>
                                        </View>

                                        <View style={{ width: '100%', marginVertical: 10, }}>
                                            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                                <View style={{ width: 8, height: 8, backgroundColor: Color.cloudyGrey, borderRadius: 50 }}></View>
                                                <Text style={{ fontSize: 15, color: Color.cloudyGrey, textAlign: 'justify', marginHorizontal: 10, fontWeight: '600', lineHeight: 25, letterSpacing: 0.5 }}>We collect personal information from you when you register on our website, create a profile, upload a resume, apply for a job, or contact us. The types of information we collect may include your name, email address, phone number, location, education, work experience, skills, references and other relevant details. We use this information to provide you with our services, match you with suitable job opportunities, communicate with you and improve our website.</Text>
                                            </View>
                                        </View>
                                        ...
                                        <View style={{ width: '100%', marginVertical: 10, }}>
                                            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                                <View style={{ width: 8, height: 8, backgroundColor: Color.cloudyGrey, borderRadius: 50 }}></View>
                                                <Text style={{ fontSize: 15, color: Color.cloudyGrey, textAlign: 'justify', marginHorizontal: 10, fontWeight: '600', lineHeight: 25, letterSpacing: 0.5 }}>We do not sell or share your personal information with third parties without your consent, except as required by law or to fulfil a legitimate business purpose. We may disclose your information to our affiliates or partners who help us operate our website or provide services to you. We may also transfer your information in the event of a merger, acquisition or sale of our business.</Text>
                                            </View>
                                        </View>
                                        ...
                                        <View style={{ width: '100%', marginVertical: 10, }}>
                                            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                                <View style={{ width: 8, height: 8, backgroundColor: Color.cloudyGrey, borderRadius: 50 }}></View>
                                                <Text style={{ fontSize: 15, color: Color.cloudyGrey, textAlign: 'justify', marginHorizontal: 10, fontWeight: '600', lineHeight: 25, letterSpacing: 0.5 }}>We take reasonable measures to protect your personal information from unauthorized access, use or disclosure. However, we cannot guarantee the security of your data transmitted over the internet or stored on our servers.You are responsible for keeping your password and account details confidential and for logging out of your account when using a shared device.</Text>
                                            </View>
                                        </View>
                                        ...
                                        <View style={{ width: '100%', marginVertical: 10, }}>
                                            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                                <View style={{ width: 8, height: 8, backgroundColor: Color.cloudyGrey, borderRadius: 50 }}></View>
                                                <Text style={{ fontSize: 15, color: Color.cloudyGrey, textAlign: 'justify', marginHorizontal: 10, fontWeight: '600', lineHeight: 25, letterSpacing: 0.5 }}>You have the right to access, update or delete your personal information at any time by logging into your account or contacting us. You can also opt out of receiving marketing emails from us by following the unsubscribe link in the email.</Text>
                                            </View>
                                        </View>
                                        ...
                                        <View style={{ width: '100%', marginVertical: 10, alignItems: 'center' }}>
                                            ...
                                            <Text style={{ width: '95%', fontSize: 15, color: Color.cloudyGrey, textAlign: 'justify', marginHorizontal: 5, marginTop: 10, fontWeight: '600', lineHeight: 25, letterSpacing: 0.5 }}>For any other queries and feedback can reach us with below address </Text>
