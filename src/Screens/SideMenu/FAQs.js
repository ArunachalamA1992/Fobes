                                    ...
                                    <View style={{ width: '97%', }}>
                                        ...
                                        <View style={{ width: '95%', marginVertical: 10, }}>
                                            <View style={{ flexDirection: 'row', alignItems: 'center', paddingHorizontal: 10, }}>
                                                <Text style={{ fontSize: 16, color: '#000', textAlign: 'justify', marginHorizontal: 10, fontFamily: 'Poppins-SemiBold', }}>1</Text>
                                                <View style={{ width: 5, height: 5, backgroundColor: '#666', borderRadius: 50 }}></View>
                                                <Text style={{ fontSize: 16, color: '#000', textAlign: 'justify', marginHorizontal: 10, fontFamily: 'Poppins-SemiBold', }}>How is Fobes different from other traditional portals?</Text>
                                            </View>
                                            <View style={{ width: '100%', paddingVertical: 10, paddingHorizontal: 15 }}>
                                                <Text style={{ textAlign: 'justify', fontSize: 16, color: '#666', lineHeight: 25, fontFamily: 'Poppins-Regular' }}>Traditional hiring is long, expensive, and inefficient. Fobes simplifies the process by connecting employers directly with job seekers with relevant skills and experience.</Text>
                                            </View>
                                        </View>
                                        ...
                                        <View style={{ width: '95%', marginVertical: 10, }}>
                                            <View style={{ flexDirection: 'row', alignItems: 'center', paddingHorizontal: 10, }}>
                                                ...
                                                <View style={{ width: 5, height: 5, backgroundColor: '#666', borderRadius: 50 }}></View>
                                                <Text style={{ fontSize: 16, color: '#000', textAlign: 'justify', marginHorizontal: 10, fontFamily: 'Poppins-SemiBold', }}>How can I get the best company from your portal?</Text>
                                            </View>
                                            <View style={{ width: '100%', paddingVertical: 10, paddingHorizontal: 15 }}>
                                                <Text style={{ textAlign: 'justify', fontSize: 16, color: '#666', lineHeight: 25, fontFamily: 'Poppins-Regular' }}>Fobes has over 5000 active companies across 70+ job categories. Our AI algorithm selects the best-fit company for your resume.</Text>
                                            </View>
                                        </View>
                                        ...
                                        <View style={{ width: '95%', marginVertical: 10, }}>
                                            <View style={{ flexDirection: 'row', alignItems: 'center', paddingHorizontal: 10, }}>
                                                ...
                                                <View style={{ width: 5, height: 5, backgroundColor: '#666', borderRadius: 50 }}></View>
                                                <Text style={{ fontSize: 16, color: '#000', textAlign: 'justify', marginHorizontal: 10, fontFamily: 'Poppins-SemiBold', }}>Do I need to pay to apply to a job or get an Interview call?</Text>
                                            </View>
                                            <View style={{ width: '100%', paddingVertical: 10, paddingHorizontal: 15 }}>
                                                <Text style={{ textAlign: 'justify', fontSize: 16, color: '#666', lineHeight: 25, fontFamily: 'Poppins-Regular' }}>No. You can apply to jobs for FREE on Fobes.</Text>
                                            </View>
                                        </View>
                                        ...
                                        <View style={{ width: '95%', marginVertical: 10, }}>
                                            <View style={{ flexDirection: 'row', alignItems: 'center', paddingHorizontal: 10, }}>
                                                ...
                                                <View style={{ width: 5, height: 5, backgroundColor: '#666', borderRadius: 50 }}></View>
                                                <Text style={{ fontSize: 16, color: '#000', textAlign: 'justify', marginHorizontal: 10, fontFamily: 'Poppins-SemiBold', }}>Recruiters are asking me to pay to schedule interview for job?</Text>
                                            </View>
                                            <View style={{ width: '100%', paddingVertical: 10, paddingHorizontal: 15 }}>
                                                <Text style={{ textAlign: 'justify', fontSize: 16, color: '#666', lineHeight: 25, fontFamily: 'Poppins-Regular' }}>Note that genuine recruiters do not ask for money to schedule interviews or offer a job. If you are receiving such calls or emails, beware as this might be a job scam.</Text>
                                            </View>
                                        </View>
                                    </View>
                                </View>
