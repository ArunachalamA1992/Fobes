  ...
  return (
    <View style={{ width: '75%', flexDirection: 'row', alignItems: 'center', }}>
      ...
      <View style={{ width: '100%', alignItems: 'flex-start', paddingHorizontal: 15 }}>
        <Text style={{ fontSize: 11, color: Color.white, fontFamily: Poppins.Medium }}>Welcome Back!</Text>
        <Text style={{ width: '100%', textAlign: 'justify', fontSize: 14, color: Color.white, fontFamily: Poppins.SemiBold }} numberOfLines={1}>Aruanchalam Annamalai</Text>
      </View>
    </View>
  );
};
